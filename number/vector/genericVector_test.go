...
func Test_GenericFilledVector(t *testing.T) {
	// Simple 3D integer vector
	v := genericFilledVector([]int{1, 2, 3})
	if v.Get(0).(int) != 1 {
...
func Test_GenericUnit(t *testing.T) {
	...
	v1 := genericFilledVector([]float32{4.0, 0.0, 0.0})
	w1 := v1.Unit()
...
func Test_GenericSub(t *testing.T) {
	...
	v1 := genericFilledVector([]int{1, 2, 3})
	w1 := v1.Sub(v1)
	if w1.Get(0).(int) != 0 {
	...
	v2 := genericFilledVector([]float32{1.0, 2.2, 3.3})
	w2 := v2.Sub(v2)
...
func Test_GenericDivs(t *testing.T) {
	...
	v2 := genericFilledVector([]float32{1.1, 2.2, 3.3})
